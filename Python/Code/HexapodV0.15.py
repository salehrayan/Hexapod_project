...
reward ~ speed_x/(1 + speed_y * speed_x + speed_x * num_femur_collisions) - energy - tibia's tip
...
dir_path = 'HexapodV0_PPO_2stacked_20tibiaContact_directionRewardWithVelxCoeff_collisionReward_results'
